...
source_dir = os.path.join(WORK_DIR, 'datasets/euro_sat/2750')  # replace with the path to your dataset
base_dir = os.path.join(WORK_DIR, 'datasets/EuroSAT_splits')  # replace with the path to the output directory
