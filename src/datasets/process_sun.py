...
downloaded_data_path = os.path.join(WORK_DIR,'datasets/sun397/SUN397')
process_dataset(os.path.join(WORK_DIR, 'datasets/sun397/Training_01.txt'), downloaded_data_path, os.path.join(WORK_DIR,'datasets/sun397/train'))
process_dataset(os.path.join(WORK_DIR,'datasets/sun397/Testing_01.txt'), downloaded_data_path, os.path.join(WORK_DIR,'datasets/sun397/val'))
